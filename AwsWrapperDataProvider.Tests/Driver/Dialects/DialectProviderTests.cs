...
//        this.mockCommand.Setup(c => c.ExecuteReaderAsync()).ReturnsAsync(this.mockReader.Object);
//    }
...
//        this.mockReader.Setup(reader => reader.ReadAsync()).ReturnsAsync(() => query switch
//        {
...
//        var updatedDialect = this.dialectProvider.UpdateDialectAsync(this.mockConnection.Object, initialDialect);
...
//    {
//        this.mockReader.Setup(r => r.ReadAsync()).ReturnsAsync(false);
...
//            typeof(PgDialect),
//        ]);
//        initialDialectMock.Setup(d => d.IsDialect(this.mockConnection.Object)).ReturnsAsync(true);
//        var updatedDialect = this.dialectProvider.UpdateDialectAsync(this.mockConnection.Object, initialDialectMock.Object);
...
//            this.dialectProvider.UpdateDialectAsync(this.mockConnection.Object, unknownDialect));
//    }
...
//        string query = string.Empty;
//        this.mockCommand.SetupSet(c => c.CommandText = It.IsAny<string>()).Callback<string>(commandText => query = commandText);
//        this.mockReader.Setup(r => r.ReadAsync()).ReturnsAsync(() => query switch
//            {
...
//        var updatedDialect = this.dialectProvider.UpdateDialectAsync(this.mockConnection.Object, unknownDialect);
...
//        var updatedDialect = this.dialectProvider.UpdateDialectAsync(this.mockConnection.Object, mysqlDialect);
...
//        string query = string.Empty;
//        this.mockCommand.SetupSet(c => c.CommandText = It.IsAny<string>()).Callback<string>(commandText => query = commandText);
//        this.mockReader.Setup(r => r.ReadAsync()).ReturnsAsync(() =>
//        {
//            switch (query)
//            {
...
//    {
//        this.mockCommand.Setup(c => c.ExecuteReaderAsync()).Throws(new MockDbException());
