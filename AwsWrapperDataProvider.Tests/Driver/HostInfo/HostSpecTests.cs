...
public class HostSpecTests
{
    ...
    public void Equals_WithSameInstance_ShouldReturnTrue()
    {
        ...
        // Act & Assert
        Assert.True(hostSpec.Equals(hostSpec));
    }
    ...
    public void Equals_WithDifferentValues_ShouldReturnExpectedResult(
        string host1, string host2, int port1, int port2,
        HostRole role1, HostRole role2,
        HostAvailability availability1, HostAvailability availability2,
        bool expectedResult)
    {
        // Arrange
