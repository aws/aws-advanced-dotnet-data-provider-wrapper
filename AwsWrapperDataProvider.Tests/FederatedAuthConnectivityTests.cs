...
public class FederatedAuthConnectivityTests
{
    [Fact]
    ...
    public void PgWrapperOktaConnectionTest()
    {
        const string connectionString =
            "Host=<host>;Database=<database>;DbUser=<db user>;Plugins=okta;IamRoleArn=<iam role arn>;IamIdpArn=<iam saml arn>;IdpEndpoint=<idp endpoint>;IdpPort=<idp port>;IdpUsername=<username>;IdpPassword=<password>;AppId=<app id>;";
    ...
    {
        const string connectionString =
            "Server=<host>;Initial Catalog=mysql;Database=<database>;DbUser=<db user>;Plugins=okta;IamRoleArn=<iam role arn>;IamIdpArn=<iam saml arn>;IdpEndpoint=<idp endpoint>;IdpPort=<idp port>;IdpUsername=<username>;IdpPassword=<password>;AppId=<app id>;";
