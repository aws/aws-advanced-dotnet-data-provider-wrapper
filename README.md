...
Wrapped datasources allows for users to disables server certificate verification. **This configuration poses significant security risks and should never be used in production environments.**
...
**Recommendations:**
- **Never disabled SSL verification in production environments**
