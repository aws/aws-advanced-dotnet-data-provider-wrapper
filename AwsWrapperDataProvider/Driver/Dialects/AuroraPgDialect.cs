...
public class AuroraPgDialect : PgDialect, ITopologyDialect, IAuroraLimitlessDialect, IBlueGreenDialect
{
    ...
    protected static readonly string AuroraPostgreSqlBgStatusQuery = $"SELECT * FROM pg_catalog.get_blue_green_fast_switchover_metadata('{DriverInfo.NameAndVersion}')";
