...
public sealed class RdsUrlType
{
    ...
    /// </summary>
    public static readonly RdsUrlType IpAddress = new(false, false, false);

    /// <summary>
    /// Represents an RDS cluster writer endpoint (e.g., mydb.cluster-123456789012.us-east-1.rds.amazonaws.com).
    /// </summary>
    public static readonly RdsUrlType RdsWriterCluster = new(true, true, true);

    /// <summary>
    /// Represents an RDS cluster reader endpoint (e.g., mydb.cluster-ro-123456789012.us-east-1.rds.amazonaws.com).
    /// </summary>
    public static readonly RdsUrlType RdsReaderCluster = new(true, true, true);

    /// <summary>
    /// Represents an RDS custom cluster endpoint (e.g., mydb.cluster-custom-123456789012.us-east-1.rds.amazonaws.com).
    /// </summary>
    public static readonly RdsUrlType RdsCustomCluster = new(true, true, true);

    /// <summary>
    /// Represents an RDS proxy endpoint (e.g., mydb.proxy-123456789012.us-east-1.rds.amazonaws.com).
    /// </summary>
    public static readonly RdsUrlType RdsProxy = new(true, false, true);

    /// <summary>
    /// Represents an RDS instance endpoint (e.g., mydb.123456789012.us-east-1.rds.amazonaws.com).
    /// </summary>
    public static readonly RdsUrlType RdsInstance = new(true, false, true);

    /// <summary>
    /// Represents an RDS Aurora limitless shard group (e.g., mydb.shardgrp-123456789012.us-east-1.rds.amazonaws.com).
    /// </summary>
    public static readonly RdsUrlType RdsAuroraLimitlessDbShardGroup = new(true, false, true);

    /// <summary>
    /// Represents an Aurora Global Database writer cluster endpoint (e.g., mydb.global-123456789012.global.rds.amazonaws.com).
    /// </summary>
    public static readonly RdsUrlType RdsGlobalWriterCluster = new(true, true, false);

    /// <summary>
    /// Represents any other type of hostname that doesn't match the RDS endpoint patterns.
    /// </summary>
    public static readonly RdsUrlType Other = new(false, false, false);
    ...
    private RdsUrlType(bool isRds, bool isRdsCluster, bool hasRegion)
    {
        this.IsRds = isRds;
