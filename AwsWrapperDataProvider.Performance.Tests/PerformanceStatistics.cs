...
public class PerformanceStatistics
{
    ...
    public override string ToString()
    {
        return
            ...
            $"\nParamFailoverDelayMillis={this.ParameterFailoverDelayMs}," +
            $"\nFailureDetectionTimeMillis={this.FailureDetectionTimeMs}," +
            $"\nReconnectTimeMillis={this.ReconnectTimeMs}," +
            $"\nDnsUpdateTimeMillis={this.DnsUpdateTimeMs} ]";
    }
}
